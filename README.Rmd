...
The goal of _regexcite_ is to make regular expressions more exciting!
...
You can install the development version of _regexcite_ from [GitHub](https://github.com/) with:
